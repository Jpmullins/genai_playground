"""GenAI-Playground test configuration.
...
from genaiplayground.extras.misc import get_current_device, is_env_enabled
from genaiplayground.train.test_utils import patch_valuehead_model
