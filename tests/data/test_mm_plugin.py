...
from genaiplayground.data.mm_plugin import get_mm_plugin
from genaiplayground.extras.packages import is_transformers_version_greater_than
from genaiplayground.hparams import get_infer_args
...
if TYPE_CHECKING:
    ...
    from genaiplayground.data.mm_plugin import BasePlugin
    from genaiplayground.model.loader import TokenizerModule
