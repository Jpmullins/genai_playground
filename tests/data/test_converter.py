from genaiplayground.data import Role
from genaiplayground.data.converter import get_dataset_converter
from genaiplayground.data.parser import DatasetAttr
from genaiplayground.hparams import DataArguments


def test_alpaca_converter():
    dataset_attr = DatasetAttr("hf_hub", "genaiplayground/tiny-supervised-dataset")
