...
from genaiplayground.data import get_template_and_fix_tokenizer
from genaiplayground.data.template import parse_template
from genaiplayground.hparams import DataArguments
...
TINY_LLAMA4 = os.getenv("TINY_LLAMA4", "genaiplayground/tiny-random-Llama-4")
...
def test_ollama_modelfile():
    ...
    assert template.get_ollama_modelfile(tokenizer) == (
        "# ollama modelfile auto-generated by genaiplayground\n\n"
        "FROM .\n\n"
