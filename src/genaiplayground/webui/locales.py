LOCALES = {
    "title": {
        "en": {
            "value": "<h1><center>🦙🏭GenAI Playground: Unified Efficient Fine-Tuning of 100+ LLMs</center></h1>",
        },
        "ru": {
            "value": "<h1><center>🦙🏭GenAI Playground: Унифицированная эффективная тонкая настройка 100+ LLMs</center></h1>",
        },
        "zh": {
            "value": "<h1><center>🦙🏭GenAI Playground: 一站式大模型高效微调平台</center></h1>",
        },
        "ko": {
            "value": "<h1><center>🦙🏭GenAI Playground: 100+ LLMs를 위한 통합 효율적인 튜닝</center></h1>",
        },
        "ja": {
            "value": "<h1><center>🦙🏭GenAI Playground: 100+ LLMs の統合効率的なチューニング</center></h1>",
        },
    },
    "subtitle": {
        "en": {
            "value": (
                "<h3><center>Visit <a href='https://github.com/genai-playground/genai-playground' target='_blank'>"
                "GitHub Page</a> <a href='https://genaiplayground.readthedocs.io/en/latest/' target='_blank'>"
                "Documentation</a></center></h3>"
            ),
        },
        "ru": {
            "value": (
                "<h3><center>Посетить <a href='https://github.com/genai-playground/genai-playground' target='_blank'>"
                "страницу GitHub</a> <a href='https://genaiplayground.readthedocs.io/en/latest/' target='_blank'>"
                "Документацию</a></center></h3>"
            ),
        },
        "zh": {
            "value": (
                "<h3><center>访问 <a href='https://github.com/genai-playground/genai-playground' target='_blank'>"
                "GitHub 主页</a> <a href='https://genaiplayground.readthedocs.io/zh-cn/latest/' target='_blank'>"
                "官方文档</a></center></h3>"
            ),
        },
        "ko": {
            "value": (
                "<h3><center><a href='https://github.com/genai-playground/genai-playground' target='_blank'>"
                "GitHub 페이지</a> <a href='https://genaiplayground.readthedocs.io/en/latest/' target='_blank'>"
        ...
        "ja": {
            "value": (
                "<h3><center><a href='https://github.com/genai-playground/genai-playground' target='_blank'>"
                "GitHub ページ</a> <a href='https://genaiplayground.readthedocs.io/en/latest/' target='_blank'>"
