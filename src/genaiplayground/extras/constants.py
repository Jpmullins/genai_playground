...
PLAYGROUNDBOARD_CONFIG = "playground_board_config.yaml"
...
register_model_group(
    models={
        ...
        "Gemma-2-2B-Instruct": {
            ...
            DownloadSource.OPENMIND: "GenAIPlayground/gemma-2-2b-it",
        },
        "Gemma-2-9B-Instruct": {
            DownloadSource.DEFAULT: "google/gemma-2-9b-it",
            DownloadSource.MODELSCOPE: "LLM-Research/gemma-2-9b-it",
            DownloadSource.OPENMIND: "GenAIPlayground/gemma-2-9b-it",
        },
...
register_model_group(
    models={
        ...
        "GLM-4-9B-Chat": {
            ...
            DownloadSource.OPENMIND: "GenAIPlayground/glm-4-9b-chat",
        },
        "GLM-4-9B-1M-Chat": {
...
register_model_group(
    models={
        ...
        "Llama-3-8B-Chinese-Chat": {
            ...
            DownloadSource.OPENMIND: "GenAIPlayground/Llama3-Chinese-8B-Instruct",
        },
...
register_model_group(
    models={
        "MiniCPM3-4B-Chat": {
            ...
            DownloadSource.OPENMIND: "GenAIPlayground/MiniCPM3-4B",
        },
    },
    template="cpm3",
)
...
register_model_group(
    models={
        ...
        "Qwen2-VL-2B-Instruct": {
            ...
            DownloadSource.OPENMIND: "GenAIPlayground/Qwen2-VL-2B-Instruct",
        },
        "Qwen2-VL-7B-Instruct": {
            DownloadSource.DEFAULT: "Qwen/Qwen2-VL-7B-Instruct",
            DownloadSource.MODELSCOPE: "Qwen/Qwen2-VL-7B-Instruct",
            DownloadSource.OPENMIND: "GenAIPlayground/Qwen2-VL-7B-Instruct",
        },
...
register_model_group(
    models={
        ...
        "Yi-1.5-6B-Chat": {
            ...
            DownloadSource.OPENMIND: "GenAIPlayground/Yi-1.5-6B-Chat",
        },
        "Yi-1.5-9B-Chat": {
