...
def try_download_model_from_other_hub(model_args: "ModelArguments") -> str:
    ...
    if use_modelscope():
        ...
        with WeakFileLock(os.path.abspath(os.path.expanduser("~/.cache/genaiplayground/modelscope.lock"))):
    ...
    if use_openmind():
        ...
        with WeakFileLock(os.path.abspath(os.path.expanduser("~/.cache/genaiplayground/openmind.lock"))):
            model_path = snapshot_download(
                model_args.model_name_or_path,
