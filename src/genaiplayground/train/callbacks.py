...
class LogCallback(TrainerCallback):
    ...
    def __init__(self) -> None:
        ...
        self.do_train = False
        # Web UI
        self.webui_mode = is_env_enabled("PLAYGROUNDBOARD_ENABLED")
        if self.webui_mode and not use_ray():
            signal.signal(signal.SIGABRT, self._set_abort)
            self.logger_handler = logging.LoggerHandler(os.getenv("PLAYGROUNDBOARD_WORKDIR"))
...
class ReporterCallback(TrainerCallback):
    ...
    def __init__(
        ...
        os.environ["WANDB_PROJECT"] = os.getenv("WANDB_PROJECT", "genaiplayground")
