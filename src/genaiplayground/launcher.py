...
USAGE = (
    ...
    + "\n"
    + "| Usage:                                                             |\n"
    + "|   genaiplayground-cli api -h: launch an OpenAI-style API server    |\n"
    + "|   genaiplayground-cli chat -h: launch a chat interface in CLI      |\n"
    + "|   genaiplayground-cli export -h: merge LoRA adapters and export    |\n"
    + "|   genaiplayground-cli train -h: train models                       |\n"
    + "|   genaiplayground-cli webchat -h: launch a chat interface in Web UI|\n"
    + "|   genaiplayground-cli webui: launch Playground UI                  |\n"
    + "|   genaiplayground-cli env: show environment info                   |\n"
...
if __name__ == "__main__":
    from genaiplayground.train.tuner import run_exp  # use absolute import
