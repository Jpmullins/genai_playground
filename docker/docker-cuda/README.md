...
This directory contains Docker configuration files for running GenAI Playground with NVIDIA GPU support.
...
docker build -f ./docker/docker-cuda/Dockerfile \
    ...
    -t genaiplayground:latest .

# Run the container
docker run -dit --ipc=host --gpus=all \
    -p 7860:7860 \
    -p 8000:8000 \
    --name genaiplayground \
    genaiplayground:latest
