...
from genaiplayground.model import load_model, load_tokenizer
from genaiplayground.train.callbacks import LogCallback
from genaiplayground.train.sft.trainer import CustomSeq2SeqTrainer
...
def bench_qwen(
    ...
    os.environ["PLAYGROUNDBOARD_ENABLED"] = "true"
    os.environ["PLAYGROUNDBOARD_WORKDIR"] = "output/dummy_dir"
    args = {
